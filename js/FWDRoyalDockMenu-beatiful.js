...
(function (e) {
    var t = function (n, r) {
        ...
        this.setupMainContainers = function () {
            ...
            i.selector_do = new FWDComboBoxSelector(i.arrowW, i.arrowH, i.arrowN_str, i.arrowS_str, i.selectorLabel_str, i.selectorBkColorN_str1, i.selectorBkColorS_str1, i.selectorBkColorN_str2, i.selectorBkColorS_str2, i.selectorTextColorN_str, i.selectorTextColorS_str, i.buttonHeight);
            ...
            for (var t = 0; t < i.totalButtons; t++) {
                ...
                e = new FWDComboBoxButton(i.categories_ar[t], i.itemBkColorN_str1, i.itemBkColorS_str1, i.itemBkColorN_str2, i.itemBkColorS_str2, i.itemTextColorN_str, i.itemTextColorS_str, t, i.buttonHeight);
                i.buttons_ar[t] = e;
        ...
        this.hide = function (e, t) {
            ...
            if (e) {
                TweenMax.to(i.buttonsHolder_do, .6, {
...
(function () {
    var e = function (t, n, r, i, s, o, u, a, f) {
        ...
        l.setupMainContainers = function () {
            ...
            l.dumy_sdo = new FWDSimpleDisplayObject("div");
            if (FWDUtils.isIE) {
        ...
        l.onMouseOver = function (t) {
            ...
            if (!t.pointerType || t.pointerType == t.MSPOINTER_TYPE_MOUSE) {
                TweenMax.killTweensOf(l.text_sdo);
        ...
        this.setSelectedState = function (e) {
            if (e) {
                ...
                TweenMax.to(l.text_sdo.screen, .6, {
                    css: {
        ...
        l.destroy = function () {
            ...
            TweenMax.killTweensOf(l.text_sdo.screen);
            TweenMax.killTweensOf(l.bk_sdo.screen);
            l.text_sdo.destroy();
            l.bk_sdo.destroy();
            l.dumy_sdo.destroy();
            l.bk_sdo = null;
...
(function () {
    var e = function (t, n, r, i, s, o, u, a, f, l, c, h) {
        ...
        p.setupMainContainers = function () {
            ...
            p.arrowN_sdo = new FWDSimpleDisplayObject("div");
            p.arrowN_sdo.screen.style.backgroundImage = "url(" + p.arrowN_str + ")";
            p.arrowS_sdo = new FWDSimpleDisplayObject("div");
            ...
            p.dumy_sdo = new FWDSimpleDisplayObject("div");
            if (FWDUtils.isIE) {
        ...
        p.onMouseOver = function (t) {
            ...
            if (!t.pointerType || t.pointerType == t.MSPOINTER_TYPE_MOUSE) {
                TweenMax.killTweensOf(p.text_sdo);
        ...
        p.onClick = function (t) {
            if (p.isDeveleper_bl) {
                window.open("https://www.webdesign-flash.ro", "_blank");
                return
            }
            if (p.isDisabled_bl) return;
            if (t.preventDefault) t.preventDefault();
        ...
        this.setSelectedState = function (e) {
            if (e) {
                ...
                TweenMax.to(p.text_sdo.screen, .6, {
                    css: {
                        color: p.textSelectedColor_str
                    },
                    ease: Quart.easeOut
                });
                TweenMax.to(p.arrowS_sdo, .6, {
                    alpha: 1,
                    ease: Quart.easeOut
                })
            } else {
        ...
        this.disable = function () {
            ...
            if (FWDUtils.hasTransform2d) {
                TweenMax.to(p.arrowN_sdo.screen, .6, {
                    css: {
                        rotation: 180
                    },
                    ease: Quart.easeOut
                });
                TweenMax.to(p.arrowS_sdo.screen, .6, {
                    css: {
                        rotation: 180
                    },
                    ease: Quart.easeOut
        ...
        p.destroy = function () {
            ...
            TweenMax.killTweensOf(p.text_sdo);
            TweenMax.killTweensOf(p.colorObj);
            p.text_sdo.destroy();
            p.dumy_sdo.destroy();
            p.text_sdo = null;
            p.dumy_sdo = null;
...
(function () {
    var e = function (e, t) {
        var n = this;
        this.parent = e;
        this.url = "https://www.webdesign-flash.ro";
        this.menu_do = null;
    ...
    var t = function (e, t, n, r) {
        ...
        this.setX = function (e) {
            ...
            if (i.hasTransform2d_bl) {
                i.screen.style[i.transform] = "translate(" + i.x + "px," + i.y + "px) scale(" + i.scale + " , " + i.scale + ") rotate(.01deg)"
            } else {
                i.screen.style.left = i.x + "px"
            }
        };
...
(function (e) {
    var t = function (n) {
        ...
        this.showCurrentItem = function () {
            ...
            } else if (this.type_str.toLowerCase().indexOf("https://www.youtube") != -1 || this.type_str.toLowerCase().indexOf("https://youtube") != -1 || this.type_str.toLowerCase().indexOf("youtube.com") != -1) {
            ...
            } else if (this.type_str.toLowerCase().indexOf("https://www.vimeo") != -1 || this.type_str.toLowerCase().indexOf("https://vimeo") != -1 || this.type_str.toLowerCase().indexOf("vimeo.com") != -1) {
                this.iframeW = this.data_ar[this.id].width || this.defaultIframeW;
                this.iframeH = this.data_ar[this.id].height || this.defaultIframeH;
        ...
        this.showIframeContent = function () {
            ...
            if (r.type_str == t.YOUTUBE) {
                ...
                if (r.videoAutoPlay_bl) {
                    e.src = "https://player.vimeo.com/video/" + r.videoIdOrIframeUrl + "?autoplay=1"
                } else {
                    e.src = "https://player.vimeo.com/video/" + r.videoIdOrIframeUrl
                }
        ...
        this.setupPreloader = function () {
            ...
            this.preloader_do = new FWDPreloader(this.preloaderImg, 57, 28, 21, 50);
...
(function (e) {
    var t = function (e) {
        ...
        this.parseProperties = function () {
            var e;
            if (!n.propsObj.dockMenuDataListDivId) {
                e = "DockMenu data list id is not defined in FWDRDMDockMenu constructor function!";
                n.dispatchEvent(t.LOAD_ERROR, {
                    text: e
                });
                return
            }
            n.rootElement = FWDUtils.getChildById(n.propsObj.dockMenuDataListDivId);
            if (!n.rootElement) {
                e = "Make sure that the div with the id <font color='#FFFFFF'>" + n.propsObj.dockMenuDataListDivId + "</font> exists, this represents the dockMenu data list.";
                n.dispatchEvent(t.LOAD_ERROR, {
                    text: e
                });
                return
            ...
            n.thumbMinScale = n.propsObj.thumbnailsMinimumScale || .5;
            n.thumbSpace = n.propsObj.thumbnailsSpace || 10;
            n.sideSpace = n.propsObj.thumbnailsSideSpace || 10;
            n.inflDist = n.propsObj.thumbnailsInfluenceDistance || 400;
            ...
            n.autoplaySpeed = n.propsObj.autoplaySpeed || 20;
            ...
            if (n.propsObj.comboBoxPosition == "topleft" || n.propsObj.comboBoxPosition == "topright") {
                n.comboBoxPosition = FWDUtils.trim(n.propsObj.comboBoxPosition).toLowerCase()
            } else {
            ...
            for (var y = 0; y < i; y++) {
                ...
                a = [];
                u = [];
                p = FWDUtils.getChildren(l);
                c = p.length;
                for (var b = 0; b < c; b++) {
                    var w = {};
                    var E = p[b];
                    var f = FWDUtils.getChildren(E);
                    m = y + 1;
                    g = b + 1;
                    h = f.length;
                    if (n.showThumbnailsHtmlContent) {
                        ...
                        for (var S = 0; S < h; S++) {
                            v = "data-html-content";
                            if (FWDUtils.hasAttribute(f[S], "data-html-content")) {
                                x = false;
                        ...
                        for (var S = 0; S < h; S++) {
                            ...
                            if (FWDUtils.hasAttribute(f[S], "data-thumbnail-path")) {
                                x = false;
                                w.thumbPath = FWDUtils.trim(FWDUtils.getAttributeValue(f[S], "data-thumbnail-path"));
                                break
                            }
                        }
                        if (x) {
                        ...
                        for (var S = 0; S < h; S++) {
                            v = "data-tooltip-text";
                            if (FWDUtils.hasAttribute(f[S], "data-tooltip-text")) {
                                x = false;
                    ...
                    for (var S = 0; S < h; S++) {
                        v = "data-type";
                        if (FWDUtils.hasAttribute(f[S], "data-type")) {
                            x = false;
                            w.mediaType = FWDUtils.trim(FWDUtils.getAttributeValue(f[S], "data-type"));
                            break
                        }
                    }
                    if (x) {
                    ...
                    if (w.mediaType != "none") {
                        ...
                        for (var S = 0; S < h; S++) {
                            v = "data-url";
                            if (FWDUtils.hasAttribute(f[S], "data-url")) {
                                x = false;
                                d = f[S];
                                break
                            }
                        ...
                        var T = {};
                        T.dataType = FWDUtils.trim(FWDUtils.getAttributeValue(d, "data-type"));
                        T.url = FWDUtils.trim(FWDUtils.getAttributeValue(d, "data-url"));
                        T.target = FWDUtils.getAttributeValue(d, "data-target");
                        T.width = FWDUtils.getAttributeValue(d, "data-width");
                        T.height = FWDUtils.getAttributeValue(d, "data-height");
                        T.info = FWDUtils.getAttributeValue(d, "data-info");
                        if (!T.target) T.target = "_blank";
                        for (var S = 0; S < h; S++) {
                            if (FWDUtils.hasAttribute(f[S], "data-info")) {
                ...
                n.categoriesAr[y] = FWDUtils.getAttributeValue(l, "data-cat") || "not defined!";
                n.dataListAr[y] = a;
                if (!n.enableHtmlContent) {
                    n.lightboxAr[y] = u
                }
            }
            ...
            if (!n.propsObj.skinPath) {
                n.dispatchEvent(t.LOAD_ERROR, {
                    text: "DockMenu graphics skin path is not defined in FWDRDMDockMenu constructor function!"
                });
                return
            }
            var N = n.propsObj.skinPath + "/preloader.png";
            var C = n.propsObj.skinPath + "/slideShowPreloader.png";
            var k = n.propsObj.skinPath + "/closeButtonNormalState.png";
            var L = n.propsObj.skinPath + "/closeButtonSelectedState.png";
            var A = n.propsObj.skinPath + "/lightboxNextButtonNormalState.png";
            var O = n.propsObj.skinPath + "/lightboxNextButtonSelectedState.png";
            var M = n.propsObj.skinPath + "/lightboxPrevButtonNormalState.png";
            var _ = n.propsObj.skinPath + "/lightboxPrevButtonSelectedState.png";
            var D = n.propsObj.skinPath + "/lightboxPlayButtonNormalState.png";
            var P = n.propsObj.skinPath + "/lightboxPlayButtonSelectedState.png";
            var H = n.propsObj.skinPath + "/lightboxPauseButtonNormalState.png";
            var B = n.propsObj.skinPath + "/lightboxPauseButtonSelectedState.png";
            var j = n.propsObj.skinPath + "/maximizeButtonNormalState.png";
            var F = n.propsObj.skinPath + "/maximizeButtonSelectedState.png";
            var I = n.propsObj.skinPath + "/minimizeButtonNormalState.png";
            var q = n.propsObj.skinPath + "/minimizeButtonSelectedState.png";
            var R = n.propsObj.skinPath + "/infoButtonOpenNormalState.png";
            var U = n.propsObj.skinPath + "/infoButtonOpenSelectedState.png";
            var z = n.propsObj.skinPath + "/infoButtonCloseNormalPath.png";
            var W = n.propsObj.skinPath + "/infoButtonCloseSelectedPath.png";
...
(function (e) {
    var t = function (e, n, r) {
        ...
        this.textDO = null;
        this.tooltipDO = null;
        this.thumbSpace = r.thumbSpace;
        this.thumbWidth = r.thumbWidth;
        this.thumbHeight = r.thumbHeight;
        this.thumbMinScale = r.thumbMinScale;
        this.thumbMinWidth = this.thumbWidth * this.thumbMinScale;
        this.thumbMinHeight = this.thumbHeight * this.thumbMinScale;
        this.mouseX = 0;
        this.mouseY = 0;
        this.pos;
        this.thumbScale = 1;
        ...
        this.setupScreen = function () {
            if (n.showThumbnailsHtmlContent || !n.transparentImages) {
                ...
                i.addChild(i.borderDO);
                i.addChild(i.bgDO);
                if (i.borderSize == 0) {
                    i.borderDO.setWidth(i.thumbWidth - 2);
                    i.borderDO.setHeight(i.thumbHeight - 2);
                    i.borderDO.setX(1);
                    i.borderDO.setY(1);
                    i.bgDO.setWidth(i.thumbWidth - i.borderSize * 2 - 2);
                    i.bgDO.setHeight(i.thumbHeight - i.borderSize * 2 - 2);
                    i.bgDO.setX(i.borderSize + 1);
                    i.bgDO.setY(i.borderSize + 1)
                } else {
            ...
            i.addChild(i.imageHolderDO);
            i.setWidth(i.thumbWidth);
            i.setHeight(i.thumbHeight);
            if (!i.isMobile && (!n.showThumbnailsHtmlContent || !n.enableHtmlContent)) {
            ...
            if (i.showBoxShadow && !i.showRefl) {
                i.screen.style.boxShadow = n.thumbBoxShadowCss
            }
            i.curDataListAr = r.curDataListAr;
            if (FWDUtils.hasTransform2d) {
                switch (r.thumbsAlignment) {
                    case "top":
                        i.setTransformOrigin("0%");
                        i.setY((i.thumbHeight - i.thumbMinHeight) / 2);
                        break;
                    case "bottom":
                        ...
                        break;
                    default:
                        i.setTransformOrigin("50%")
                }
            }
            if (i.isMobile) {
                if (i.hasPointerEvent) {
                    i.screen.addEventListener("MSPointerUp", i.onMouseTouchHandler)
                } else {
                    i.screen.addEventListener("touchend", i.onMouseTouchHandler)
                }
            } else {
                if (i.showTooltip) {
                    clearTimeout(i.tooltipTimeoutId);
                    i.tooltipTimeoutId = setTimeout(i.setupTooltip, 10)
                }
            }
        };
        ...
        this.setupTooltip = function () {
            ...
            i.tooltipDO = new FWDTooltip({
                ...
                btnMode: !n.showThumbnailsHtmlContent || !n.enableHtmlContent
            });
            r.parent.mainDO.addChild(i.tooltipDO);
            i.tooltipDO.setAlpha(0);
            i.tooltipDO.setX(-2e3);
            if (!i.dynTooltip) {
                var e = -(i.thumbHeight * i.thumbScale - i.thumbHeight) / 2 + r.posY + r.yOffset - 5;
                var t = 0;
                if (!FWDUtils.hasTransform2d) {
                    switch (r.thumbsAlignment) {
                        case "top":
                            t = i.thumbHeight / 2 - i.thumbHeight * i.thumbScale / 2 + i.thumbMinHeight / 2;
                            break;
                        case "bottom":
                            t = i.thumbHeight / 2 + i.thumbHeight * i.thumbScale / 2 - i.thumbMinHeight / 2;
                            break;
                    ...
                    switch (r.thumbsAlignment) {
                        case "top":
                            t = -(i.thumbHeight * i.thumbScale - i.thumbMinHeight) / 2;
                            break;
                        case "bottom":
                            t = (i.thumbHeight * i.thumbScale - i.thumbMinHeight) / 2;
                            break;
                ...
                e -= t;
                i.tooltipDO.setX(r.posX + i.thumbWidth / 2 + i.newX);
                i.tooltipDO.setY(e)
            }
            if (i.screen.addEventListener) {
                r.parent.mainDO.screen.addEventListener("mousemove", i.onMouseMoveHandler)
            } else {
                r.parent.mainDO.screen.attachEvent("onmousemove", i.onMouseMoveHandler)
            }
        };
        this.addReflection = function () {
            ...
            i.reflCanvasDO.screen.height = i.reflHeight;
            var r = i.reflCanvasDO.screen.getContext("2d");
            r.save();
            r.translate(0, i.thumbHeight);
            r.scale(1, -1);
            if (n.showThumbnailsHtmlContent || !n.transparentImages) {
                r.fillStyle = i.borderColor1;
                r.fillRect(0, 0, i.thumbWidth, i.thumbHeight)
            }
            r.drawImage(i.imageDO.screen, i.borderSize, i.borderSize, e, t);
            r.restore();
            r.globalCompositeOperation = "destination-out";
            var s = r.createLinearGradient(0, 0, 0, i.reflHeight);
            s.addColorStop(1, "rgba(255, 255, 255, 1.0)");
            s.addColorStop(0, "rgba(255, 255, 255, " + (1 - i.reflAlpha) + ")");
            r.fillStyle = s;
            r.fillRect(0, 0, i.thumbWidth, i.reflHeight + 2);
            i.setWidth(i.thumbWidth);
            i.reflCanvasDO.setY(i.thumbHeight + i.reflDist);
        ...
        this.addImage = function (e) {
            ...
            if (i.screen.addEventListener) {
                i.screen.addEventListener("click", i.onMouseClickHandler)
            } else {
                i.screen.attachEvent("onclick", i.onMouseClickHandler)
            }
        };
        this.addHtmlContent = function () {
            i.htmlContentDO = new FWDSimpleDisplayObject("div");
        ...
        this.onMouseMoveHandler = function (e) {
            ...
            var o;
            var u;
            var a = i.thumbWidth * i.thumbScale / 2 - (r.posX + i.thumbWidth / 2) - i.newX + t.screenX - n;
            var f = (i.thumbHeight * i.thumbScale - i.thumbHeight) / 2 - r.posY - r.yOffset + t.screenY - s;
            var l = 0;
            if (!FWDUtils.hasTransform2d) {
                switch (r.thumbsAlignment) {
                    case "top":
                        l = i.thumbHeight / 2 - i.thumbHeight * i.thumbScale / 2 + i.thumbMinHeight / 2;
                        break;
                    case "bottom":
                        l = i.thumbHeight / 2 + i.thumbHeight * i.thumbScale / 2 - i.thumbMinHeight / 2;
                        break;
                ...
                switch (r.thumbsAlignment) {
                    case "top":
                        l = -(i.thumbHeight * i.thumbScale - i.thumbMinHeight) / 2;
                        break;
                    case "bottom":
                        l = (i.thumbHeight * i.thumbScale - i.thumbMinHeight) / 2;
                        break;
            ...
            f += l;
            if (a >= 0 && a <= i.thumbWidth * i.thumbScale && f >= -1 && f <= i.thumbHeight * i.thumbScale + 1) {
                if (!i.isOver) {
                    i.isOver = true;
                    if (FWDUtils.isIEAndLessThen9) {
                        ...
                        var u = -(i.thumbHeight * i.thumbScale - i.thumbHeight) / 2 + r.posY + r.yOffset - 5;
                        var l = 0;
                        if (!FWDUtils.hasTransform2d) {
                            switch (r.thumbsAlignment) {
                                case "top":
                ...
                if (i.dynTooltip) {
                    ...
                    u = t.screenY - s - 2;
                    var c = 0;
                    var h = i.tooltipDO.getTooltipWidth() / 2;
                    var p = i.tooltipDO.getTooltipHeight();
                    var d = false;
                    if (o > r.stageWidth - h) {
                        c = o - r.stageWidth + h;
                        o = r.stageWidth - h
                    ...
                    i.tooltipDO.setPointerDX(c);
                    i.tooltipDO.swapTooltip(d);
                    o = Math.floor(o);
                    u = Math.floor(u);
                    i.tooltipDO.setX(o);
                    i.tooltipDO.setY(u)
                } else {
                    o = t.screenX - n - a + i.thumbWidth * i.thumbScale / 2;
                    u = t.screenY - s - f - 5;
                    var c = 0;
                    var h = i.tooltipDO.getTooltipWidth() / 2;
                    if (o > r.stageWidth - h) {
                    ...
                    o = Math.floor(o);
                    u = Math.floor(u);
                    if (FWDUtils.isIEAndMoreThen8) {
                        i.tooltipDO.setX(o);
                        i.tooltipDO.setY(u)
                    } else {
                        TweenMax.to(i.tooltipDO, .3, {
                            x: o,
                            y: u
                        })
                    }
        ...
        this.showThumb = function () {
            if (!FWDUtils.hasTransform2d) {
                var e = i.thumbWidth * i.thumbScale;
                var t = i.thumbHeight * i.thumbScale;
                var r = i.borderSize * i.thumbScale;
                if (i.borderSize > 0 && r < 1) {
                    r = 1
                }
                var s = e - r * 2;
                var o = t - r * 2;
                i.imageHolderDO.setX(e / 2);
                i.imageHolderDO.setY(t / 2);
                ...
                if (n.showThumbnailsHtmlContent) {
                    if (i.htmlContentDO) {
                        ...
                        i.htmlContentDO.setX(-s / 2);
                        i.htmlContentDO.setY(-o / 2);
                        TweenMax.to(i.htmlContentDO, .8, {
                            x: 0,
                            y: 0,
                            ease: Expo.easeInOut
                        })
                ...
                clearTimeout(i.introTimeoutId);
                i.introTimeoutId = setTimeout(i.introReady, 800)
            } else {
                i.setScale2(i.thumbScale);
                var s = i.thumbWidth - i.borderSize * 2;
                var o = i.thumbHeight - i.borderSize * 2;
                i.imageHolderDO.setX(i.thumbWidth / 2);
                i.imageHolderDO.setY(i.thumbHeight / 2);
                i.imageHolderDO.setWidth(0);
                i.imageHolderDO.setHeight(0);
                TweenMax.to(i.imageHolderDO, .8, {
                    x: i.borderSize,
        ...
        this.introReady = function () {
            i.isReady = true
        };
        this.showThumbIntro = function (e) {
            i.thumbScale = e;
            if (!FWDUtils.hasTransform2d) {
                var t = i.thumbWidth * e;
                var n = i.thumbHeight * e;
                var r = i.borderSize * e;
                if (i.borderSize > 0 && r < 1) {
                    r = 1
                }
                var s = t - r * 2;
                ...
                i.setHeight(n);
                if (i.borderDO) {
                    i.borderDO.setWidth(t);
                    i.borderDO.setHeight(n)
                }
                if (i.bgDO) {
                    i.bgDO.setX(r);
                    i.bgDO.setY(r);
                ...
                i.setX(i.newX + (i.thumbWidth - t) / 2);
                i.setY(-i.thumbMinHeight / 2)
            } else {
                i.setScale2(i.thumbScale);
                i.setX(i.newX)
            }
        ...
        this.setScale = function (e) {
            ...
            if (!FWDUtils.hasTransform2d) {
                var t = i.thumbWidth * e;
                var s = i.thumbHeight * e;
                var o = i.borderSize * e;
                if (i.borderSize > 0 && o < 1) {
                    o = 1
                }
                if (i.borderDO) {
                    TweenMax.to(i.borderDO, .2, {
                        w: t,
                        h: s,
                        ease: Quart.easeOut
                    })
                ...
                switch (r.thumbsAlignment) {
                    case "top":
                        TweenMax.to(i, .2, {
                            x: i.newX + (i.thumbWidth - t) / 2,
                            y: -i.thumbMinHeight / 2,
                            w: t,
                            h: s,
                            ease: Quart.easeOut
                        });
        ...
        this.update = function (e, t, s, o, u, a, f) {
            i.thumbMinScale = s;
            i.thumbMinWidth = i.thumbWidth * i.thumbMinScale;
            i.thumbMinHeight = i.thumbHeight * i.thumbMinScale;
            if (i.isMobile && i.thumbWidth != e) {
                i.thumbWidth = e;
                i.thumbHeight = t;
                if (n.showThumbnailsHtmlContent || !n.transparentImages) {
                    i.borderDO.setWidth(i.thumbWidth);
            ...
            i.showRefl = a;
            i.reflDist = f;
            if (!i.isMobile && !i.tooltipDO && i.showTooltip) {
                clearTimeout(i.tooltipTimeoutId);
                i.tooltipTimeoutId = setTimeout(i.setupTooltip, 10)
            }
            if (i.showRefl) {
        ...
        this.hide = function (e) {
            if (!FWDUtils.hasTransform2d) {
                var t = i.thumbWidth * i.thumbScale;
                var r = i.thumbHeight * i.thumbScale;
                var s = i.borderSize * i.thumbScale;
                ...
                var o = i.thumbWidth - i.borderSize * 2;
                var u = i.thumbHeight - i.borderSize * 2;
                TweenMax.to(i.imageHolderDO, .8, {
                    x: i.thumbWidth / 2,
                    y: i.thumbHeight / 2,
                    w: 0,
        ...
        this.destroy = function () {
            ...
            if (i.isMobile) {
                if (i.hasPointerEvent) {
                    i.screen.removeEventListener("MSPointerUp", i.onMouseTouchHandler)
                } else {
                    i.screen.removeEventListener("touchend", i.onMouseTouchHandler)
                }
                r.parent.mainDO.screen.removeEventListener("mousemove", i.onMouseMoveHandler)
            } else {
                if (i.screen.removeEventListener) {
                    i.screen.removeEventListener("click", i.onMouseClickHandler);
                    r.parent.mainDO.screen.removeEventListener("mousemove", i.onMouseMoveHandler)
                } else {
                    i.screen.detachEvent("onclick", i.onMouseClickHandler);
                    r.parent.mainDO.screen.detachEvent("onmousemove", i.onMouseMoveHandler)
                }
            } if (i.imageDO) {
                TweenMax.killTweensOf(i.imageDO);
            ...
            if (i.htmlContentDO) {
                TweenMax.killTweensOf(i.htmlContentDO);
                i.htmlContentDO.destroy();
                i.htmlContentDO = null
            }
            if (i.tooltipDO) {
                TweenMax.killTweensOf(i.tooltipDO);
                i.tooltipDO.destroy();
                i.tooltipDO = null
            }
            if (i.bgDO) {
    ...
    t.setPrototype = function () {
        t.prototype = new FWDDisplayObjectScale("div", "absolute", "visible")
    };
    t.CLICK = "click";
    t.prototype = null;
    e.FWDRDMThumb = t
...
(function (e) {
    var t = function (n, r) {
        ...
        this.thumbSpace = n.thumbSpace;
        this.sideSpace = n.sideSpace;
        this.thumbMinScale = n.thumbMinScale;
        this.thumbMinWidth = this.thumbWidth * this.thumbMinScale;
        this.thumbMinHeight = this.thumbHeight * this.thumbMinScale;
        this.maxDist = n.inflDist;
        this.posX = 0;
        this.posY = 0;
        this.yOffset = 0;
        this.autoplaySpeed = n.autoplaySpeed;
        this.autoplayDir = 1;
        this.menuStyleTemp = n.menuStyle;
        this.menuStyle = this.menuStyleTemp;
        ...
        this.alignmentsAr = ["top", "center", "bottom"];
        this.thumbsAlignment = n.thumbsAlignment;
        this.hasPointerEvent = FWDUtils.hasPointerEvent;
        this.isMobile = FWDUtils.isMobile;
        ...
        this.init = function () {
            if (FWDUtils.hasTransform2d) {
                i.posY = (i.stageHeight - i.thumbHeight) / 2
            } else {
                i.posY = i.stageHeight / 2
            }
            i.setY(i.posY);
            i.showCurrentCat(-1)
        };
        this.showCurrentCat = function (e) {
            ...
            if (i.isMobile) {
                ...
                if (i.stageWidth < i.thumbWidth) {
                    i.thumbWidth = i.stageWidth - 20;
                    i.thumbHeight = i.thumbWidth * (n.thumbHeight / n.thumbWidth)
                } else {
                    i.thumbWidth = n.thumbWidth;
                    i.thumbHeight = n.thumbHeight
                }
                i.thumbMinWidth = i.thumbWidth * i.thumbMinScale;
                i.thumbMinHeight = i.thumbHeight * i.thumbMinScale
            }
            var t = i.totalThumbs * i.thumbWidth * 2;
            i.setWidth(t);
            i.setHeight(r.originalHeight);
            if (i.isMobile) {
                i.totalThumbs = Math.min(i.totalThumbs, n.maxNumberOfThumbsOnMobile)
            }
            if (!i.menuStyle) {
                var s = i.totalThumbs * (i.thumbSpace + i.thumbMinWidth) - i.thumbSpace;
                if (s < i.stageWidth) {
                    var o = (i.stageWidth - s) / 2;
                    i.mouseX = o
                } else {
                    i.mouseX = i.thumbWidth / 2
                }
            }
            i.curId = 0;
            i.setupThumbs();
        ...
        this.hideCurrentCat = function () {
            ...
            clearInterval(i.updateId);
            clearInterval(i.autoplayId);
            clearTimeout(i.autoplayStartId);
            clearTimeout(i.autoplayStopId);
            clearTimeout(i.tooltipHideId);
            if (i.isMobile) {
                i.removeMobileDrag()
            } else {
                if (i.screen.addEventListener) {
                    r.mainDO.screen.removeEventListener("mousemove", i.onMouseMove);
                    r.mainDO.screen.removeEventListener("mouseover", i.removeAutoplay);
                    r.mainDO.screen.removeEventListener("mouseout", i.initAutoplay)
                } else {
                    r.mainDO.screen.detachEvent("onmousemove", i.onMouseMove);
                    r.mainDO.screen.detachEvent("onmouseover", i.removeAutoplay);
                    r.mainDO.screen.detachEvent("onmouseout", i.initAutoplay)
                }
            } if (i.hasPointerEvent) {
                r.mainDO.screen.removeEventListener("MSPointerMove", i.onMouseMove)
            }
        ...
        this.hideThumbs = function () {
            ...
            i.hideThumbsFinishedId = setTimeout(i.allThumbsAreTweened, 800)
        };
        ...
        this.setupThumbs = function () {
            var e;
            for (var t = 0; t < i.totalThumbs; t++) {
                FWDRDMThumb.setPrototype();
                e = new FWDRDMThumb(t, i.data, i);
                i.thumbsAr.push(e);
                e.addListener(FWDRDMThumb.CLICK, i.onThumbClick)
            }
        };
        ...
        this.thumbClickHandler = function () {
            var r = i.curDataListAr[i.curId].mediaType;
            var s = i.curId;
            if (r == "none") {
                return
            } else if (r != "link") {
                for (var o = 0; o < i.totalThumbs; o++) {
                    if (o < i.curId && i.curDataListAr[o].mediaType == "link") {
                        s -= 1
                    }
                }
            }
            if (r == "link") {
                ...
                if (!n.showThumbnailsHtmlContent || !n.enableHtmlContent) {
                    i.disableAutoplay();
                    i.hideTooltip();
        ...
        this.loadImages = function () {
            i.setupIntro();
            i.countLoadedThumbsRight = i.curId;
        ...
        this.setupIntro = function () {
            var e;
            var t;
            for (var n = 0; n < i.totalThumbs; n++) {
                thumb = i.thumbsAr[n];
                e = n * (i.thumbMinWidth + i.thumbSpace);
                t = i.thumbMinScale;
                thumb.newX = e;
                thumb.showThumbIntro(t);
                i.addChild(thumb)
            }
            var r = i.totalThumbs * (i.thumbSpace + i.thumbMinWidth) - i.thumbSpace;
            if (r < i.stageWidth) {
                i.posX = (i.stageWidth - r) / 2 - (i.thumbWidth - i.thumbMinWidth) / 2
            } else {
                i.posX = -(i.thumbWidth - i.thumbMinWidth) / 2 + i.thumbSpace
            }
            i.setX(i.posX);
            i.setIntroFinishedId = setTimeout(i.setIntroFinished, 800)
        };
        this.setIntroFinished = function () {
            ...
            if (i.isMobile) {
                ...
                if (i.screen.addEventListener) {
                    r.mainDO.screen.addEventListener("mousemove", i.onMouseMove)
                } else {
                    r.mainDO.screen.attachEvent("onmousemove", i.onMouseMove)
                }
            } if (i.hasPointerEvent) {
                r.mainDO.screen.addEventListener("MSPointerMove", i.onMouseMove)
            }
            i.apc = 0;
            i.apc2 = 0;
            i.enableAutoplay();
        ...
        this.enableAutoplay = function () {
            i.menuStyle = i.menuStyleTemp;
            if (i.screen.addEventListener) {
                r.mainDO.screen.addEventListener("mouseover", i.removeAutoplay);
                r.mainDO.screen.addEventListener("mouseout", i.initAutoplay)
            } else {
                r.mainDO.screen.attachEvent("onmouseover", i.removeAutoplay);
                r.mainDO.screen.attachEvent("onmouseout", i.initAutoplay)
            }
            i.startAutoplay()
        };
        ...
        this.onMouseMove = function (e) {
            var t = FWDUtils.getViewportMouseCoordinates(e);
            i.mouseX = t.screenX - r.rect.left;
            i.mouseY = t.screenY - r.rect.top;
            i.updateDockMenu()
        };
        this.hideTooltip = function () {
            for (var e = 0; e < i.totalThumbs; e++) {
        ...
        this.initAutoplay = function () {
            clearTimeout(i.autoplayStartId);
            clearTimeout(i.autoplayStopId);
            i.autoplayStartId = setTimeout(i.startAutoplay, 30)
        };
        this.startAutoplay = function () {
            if (i.menuStyle) {
                ...
                clearInterval(i.autoplayId);
                i.autoplayId = setInterval(i.updateAutoplay, 20)
            }
            clearTimeout(i.tooltipHideId);
            i.tooltipHideId = setTimeout(i.hideTooltip, 100);
            if (i.menuStyle) {
                clearInterval(i.updateId);
                i.updateId = setInterval(i.updateDockMenu, 20)
            }
        };
        this.removeAutoplay = function () {
            clearInterval(i.updateId);
            clearTimeout(i.autoplayStartId);
            clearTimeout(i.autoplayStopId);
            i.autoplayStopId = setTimeout(i.stopAutoplay, 30)
        };
        ...
        this.updateAutoplay = function () {
            if (i.menuStyle) return;
            var e = (i.totalThumbs - 1) * i.thumbSpace;
            for (var t = 0; t < i.totalThumbs; t++) {
                thumb = i.thumbsAr[t];
                e += i.thumbWidth * thumb.thumbScale
            }
            if (e < i.stageWidth) {
                i.mouseX += i.autoplaySpeed / 20 * (12 / i.totalThumbs) * (e / 1e3) * i.autoplayDir;
                var n = (i.stageWidth - e) / 2;
                if (i.mouseX < i.thumbWidth / 2 - (i.stageWidth - i.thumbWidth) / ((i.totalThumbs - 1) * 4) + n) {
                    i.mouseX = i.thumbWidth / 2 - (i.stageWidth - i.thumbWidth) / ((i.totalThumbs - 1) * 4) + n;
                    i.autoplayDir = 1
                }
                if (i.mouseX > i.stageWidth - (i.thumbWidth / 2 - (i.stageWidth - i.thumbWidth) / ((i.totalThumbs - 1) * 4)) - n) {
                    i.mouseX = i.stageWidth - (i.thumbWidth / 2 - (i.stageWidth - i.thumbWidth) / ((i.totalThumbs - 1) * 4)) - n;
                    i.autoplayDir = -1
                }
            } else {
                i.mouseX += i.autoplaySpeed / 20 * (12 / i.totalThumbs) * ((i.stageWidth - i.thumbWidth) / 1e3) * i.autoplayDir;
                if (i.mouseX < i.thumbWidth / 2 - (i.stageWidth - i.thumbWidth) / ((i.totalThumbs - 1) * 2)) {
                    i.mouseX = i.thumbWidth / 2 - (i.stageWidth - i.thumbWidth) / ((i.totalThumbs - 1) * 4);
                    i.autoplayDir = 1
                }
                if (i.mouseX > i.stageWidth - (i.thumbWidth / 2 - (i.stageWidth - i.thumbWidth) / ((i.totalThumbs - 1) * 4))) {
                    i.mouseX = i.stageWidth - (i.thumbWidth / 2 - (i.stageWidth - i.thumbWidth) / ((i.totalThumbs - 1) * 4));
                    i.autoplayDir = -1
                }
            }
            i.updateDockMenu()
        };
        this.updateDockMenu = function () {
            i.updateThumbsPos();
            i.updateThumbs()
        };
        this.updateThumbsPos = function () {
            var e = (i.totalThumbs - 1) * i.thumbSpace;
            var t = [];
            for (var n = 0; n < i.totalThumbs; n++) {
                thumb = i.thumbsAr[n];
            ...
            if (e < i.stageWidth) {
                i.posX = (i.stageWidth - e) / 2 - i.thumbWidth / 2
            } else {
                i.posX = -((i.mouseX - i.thumbWidth / 2) / (i.stageWidth - i.thumbWidth)) * (e - i.stageWidth) - i.thumbWidth / 2;
                i.posX = Math.min(i.posX, i.sideSpace - i.thumbWidth / 2);
                i.posX = Math.max(i.posX, i.stageWidth - e - i.sideSpace - i.thumbWidth / 2)
            }
            for (var n = 0; n < i.totalThumbs; n++) {
                thumb = i.thumbsAr[n];
                var r = Math.abs(thumb.newX + i.posX + i.thumbWidth / 2 - i.mouseX);
                if (i.menuStyle) {
                    if (r < i.maxDist && i.mouseOver) {
                        var s = 1 + (1 - r / i.maxDist) * (i.thumbWidth / i.thumbMinWidth - 1);
                        t[n] = i.thumbMinScale * s
                    } else {
                        t[n] = i.thumbMinScale
                    }
                } else {
            ...
            thumb = i.thumbsAr[0];
            thumb.thumbScale = t[0];
            thumb.newX = i.thumbWidth * thumb.thumbScale / 2;
            for (var n = 1; n < i.totalThumbs; n++) {
                thumb = i.thumbsAr[n];
                var o = i.thumbsAr[n - 1];
                thumb.thumbScale = t[n];
                var u = thumb.newX - i.thumbWidth * thumb.thumbScale / 2 - (o.newX + i.thumbWidth * o.thumbScale / 2);
                thumb.newX = thumb.newX + i.thumbSpace - u
            }
        };
        this.updateThumbs = function () {
            ...
            for (var t = 0; t < i.totalThumbs; t++) {
                thumb = i.thumbsAr[t];
                thumb.setScale(thumb.thumbScale)
            }
            TweenMax.to(i, .3, {
                x: i.posX
            })
        ...
        this.mobileDragMoveTest = function (t) {
            ...
            i.mX = n.screenX;
            i.mY = n.screenY;
            var r = Math.atan2(i.mY - i.lastPressedY, i.mX - i.lastPressedX);
            var s = Math.abs(r) * 180 / Math.PI;
            if (s > 120 || s < 60) {
                if (t.preventDefault) t.preventDefault();
                e.addEventListener("touchmove", i.mobileDragMoveHandler)
            }
        ...
        this.mobileDragMoveHandler = function (e) {
            ...
            i.mX = t.screenX;
            i.mY = t.screenY;
            var n = (i.totalThumbs - 1) * i.thumbSpace;
            for (var r = 0; r < i.totalThumbs; r++) {
                thumb = i.thumbsAr[r];
                n += i.thumbWidth * thumb.thumbScale
            }
            var s = (i.lastPressedX - i.mX) / 5;
            if (s > 0) {
                i.autoplayDir = 1
            } else {
                i.autoplayDir = -1
            } if (n < i.stageWidth) {
                i.mouseX = i.lastMouseX + s * (12 / i.totalThumbs) * (n / 400);
                var o = (i.stageWidth - n) / 2;
                if (i.mouseX < i.thumbWidth / 2 + o) {
                    i.mouseX = i.thumbWidth / 2 + o
                }
                if (i.mouseX > i.stageWidth - i.thumbWidth / 2 - o) {
                    i.mouseX = i.stageWidth - i.thumbWidth / 2 - o
                }
            } else {
                i.mouseX = i.lastMouseX + s * (12 / i.totalThumbs) * ((i.stageWidth - i.thumbWidth) / 400);
                if (i.mouseX < i.thumbWidth / 2) {
                    i.mouseX = i.thumbWidth / 2
                }
                if (i.mouseX > i.stageWidth - i.thumbWidth / 2) {
                    i.mouseX = i.stageWidth - i.thumbWidth / 2
                }
            }
            i.updateDockMenu()
        };
        ...
        this.update = function (e) {
            i.thumbSpace = e.thumbSpace;
            i.autoplaySpeed = e.autoplaySpeed;
            i.maxDist = e.inflDist;
            i.sideSpace = e.sideSpace;
            i.yOffset = e.yOffset;
            i.menuStyleTemp = e.menuStyle;
            i.menuStyle = i.menuStyleTemp;
            i.showTooltip = e.showTooltip;
            i.dynTooltip = e.dynTooltip;
            i.showRefl = e.showRefl;
            i.reflDist = e.reflDist;
            i.thumbMinScale = e.thumbMinScale;
            i.thumbMinWidth = i.thumbWidth * i.thumbMinScale;
            i.thumbMinHeight = i.thumbHeight * i.thumbMinScale;
            i.thumbsAlignment = i.alignmentsAr[e.thumbsAlignment];
            i.updateThumbsScaleTooltip();
            i.setY(i.posY + i.yOffset);
            if (i.menuStyle) {
                clearInterval(i.updateId);
                i.updateId = setInterval(i.updateDockMenu, 20)
            }
        };
        this.updateThumbsScaleTooltip = function () {
            for (var e = 0; e < i.totalThumbs; e++) {
                i.thumbsAr[e].update(i.thumbWidth, i.thumbHeight, i.thumbMinScale, i.showTooltip, i.dynTooltip, i.showRefl, i.reflDist)
            }
        };
        this.destroy = function () {
            clearTimeout(i.loadWithDelayIdLeft);
...
(function (e) {
    var t = function (n) {
        ...
        this.init = function () {
            ...
            r.propsObj = n;
            if (!r.propsObj) {
                alert("DockMenu properties object is undefined!");
                return
            }
            ...
            if (!r.propsObj.dockMenuHolderDivId) {
                alert("Property dockMenuHolderDivId is not defined in the FWDRoyalDockMenu object constructor!");
                return
            }
            if (!FWDUtils.getChildById(r.propsObj.dockMenuHolderDivId)) {
                alert("FWDRoyalDockMenu holder div is not found, please make sure that the div exists and the id is correct! " + r.propsObj.dockMenuHolderDivId);
                return
            }
            if (!r.propsObj.dockMenuWidth) {
                alert("The dockMenu width is not defined, please make sure that the dockMenuWidth property is definded in the FWDRoyalDockMenu constructor!");
                return
            }
            if (!r.propsObj.dockMenuHeight) {
                alert("The dockMenu height is not defined, please make sure that the dockMenuHeight property is definded in the FWDRoyalDockMenu constructor!");
                return
            }
            r.stageContainer = FWDUtils.getChildById(r.propsObj.dockMenuHolderDivId);
            r.autoScale = r.propsObj.autoScale == "yes" ? true : false;
            r.originalWidth = r.propsObj.dockMenuWidth;
            r.originalHeight = r.propsObj.dockMenuHeight;
            r.setupMainDO();
            r.setupInfo();
            r.setupData();
        ...
        this.setupData = function () {
            FWDRDMData.setPrototype();
            r.data = new FWDRDMData(r.propsObj);
            r.data.addListener(FWDRDMData.PRELOADER_LOAD_DONE, r.onPreloaderLoadDone);
            r.data.addListener(FWDRDMData.LOAD_ERROR, r.dataLoadError);
            r.data.addListener(FWDRDMData.LOAD_DONE, r.dataLoadComplete)
        };
        ...
        this.setupPreloader = function () {
            FWDPreloader.setPrototype();
            r.preloaderDO = new FWDPreloader(r.data.mainPreloaderImg, 57, 28, 21, 50);
        ...
        this.setupThumbsManager = function () {
            FWDRDMThumbsManager.setPrototype();
            r.thumbsManagerDO = new FWDRDMThumbsManager(r.data, r);
            r.thumbsManagerDO.addListener(FWDRDMThumbsManager.THUMB_CLICK, r.onThumbsManagerThumbClick);
            r.thumbsManagerDO.addListener(FWDRDMThumbsManager.LOAD_ERROR, r.onThumbsManagerLoadError);
            r.thumbsManagerDO.addListener(FWDRDMThumbsManager.THUMBS_INTRO_FINISH, r.onThumbsManagerIntroFinish);
        ...
        this.setupComboBox = function () {
            ...
            r.comboBoxDO = new FWDComboBox(r, {
            ...
            r.comboBoxDO.addListener(FWDComboBox.BUTTON_PRESSED, r.onComboboxButtonPressHandler);
            r.comboBoxDO.addListener(FWDComboBox.OPEN, r.onComboboxOpenHandler);
        ...
        this.onComboboxOpenHandler = function (e) {
            r.thumbsManagerDO.hideTooltip()
        };
        ...
        this.switchCategory = function (e) {
            if (e >= 0 && e < r.data.dataListAr.length) {
                if (r.thumbsManagerDO && r.thumbsManagerDO.allowToSwitchCat) {
                    r.disableAll();
        ...
        this.setupLightBox = function () {
            ...
            r.lightboxDO.addListener(FWDLightBox.HIDE_COMPLETE, r.onLightboxHideComplete)
        };
        this.onLightboxHideComplete = function () {
            r.thumbsManagerDO.enableAutoplay()
        };
        this.setupDisable = function () {
            r.disableDO = new FWDSimpleDisplayObject("div");
            if (FWDUtils.isIE) {
        ...
        this.destroy = function () {
            ...
            if (r.thumbsBgDO) {
                TweenMax.killTweensOf(r.thumbsBgDO);
                r.thumbsBgDO.destroy()
            }
            if (r.scrollbarBgDO) {
                TweenMax.killTweensOf(r.scrollbarBgDO);
