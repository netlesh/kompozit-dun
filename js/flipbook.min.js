var FLIPBOOK = FLIPBOOK || {}; {
        ...
        o.prototype = {
            init: function (e, s) {
                ...
                if (o.options.deeplinking.enabled) {
                    ...
                    n.onhashchange = function (e) {
                        ...
                        if (typeof o.Book != "undefined") o.Book.goToPage(t, true)
                    };
                    o.options.startPage = _();
                    var D = o.options.startPage == 0 ? 1 : o.options.startPage;
                    n.location.hash = "#" + this.options.deeplinking.prefix + String(D)
                }
            },
            ...
            createBook: function () {
                ...
                if (e.options.webgl && e.hasWebGl) {
                    ...
                    if (!FLIPBOOK.scriptsLoaded[FLIPBOOK.threejsSrc]) {
                        i(FLIPBOOK.threejsSrc, e.createBook);
                        return
                    }
                    if (!FLIPBOOK.scriptsLoaded[FLIPBOOK.flipbookWebGlSrc]) {
                        i(FLIPBOOK.flipbookWebGlSrc, e.createBook);
                        return
                    }
                    var s = e.options;
                    s.pagesArr = e.options.pages;
                    s.scroll = e.scroll;
                    s.parent = e;
                    e.Book = new FLIPBOOK.BookWebGL(e.book[0], s);
                    e.webglMode = true
                } else {
                ...
                if (e.options.rightToLeft) {
                    ...
                    e.Book.goToPage(Number(e.options.startPage))
                }
                t(n).resize(function () {
                    e.resize()
                });
            ...
            createMenu: function () {
                ...
                if (THREEx.FullScreen.available() && e.options.btnExpand.enabled) {
                    this.btnExpand = this.createButton(e.options.btnExpand).addClass("btnExpand").bind(this.CLICK_EV, function () {
                    ...
                    r.addEventListener("MSFullscreenChange", function () {
                        if (THREEx.FullScreen.activated()) {
                    ...
                    r.addEventListener("mozfullscreenchange", function () {
                        if (THREEx.FullScreen.activated()) {
                            t(".btnExpand").addClass(e.options.btnExpand.iconAlt).removeClass(e.options.btnExpand.icon)
                        } else {
                            t(".btnExpand").addClass(e.options.btnExpand.icon).removeClass(e.options.btnExpand.iconAlt)
                    ...
                    r.addEventListener("webkitfullscreenchange", function () {
                        if (THREEx.FullScreen.activated()) {
                            t(".btnExpand").addClass(e.options.btnExpand.iconAlt).removeClass(e.options.btnExpand.icon)
                        } else {
                            t(".btnExpand").addClass(e.options.btnExpand.icon).removeClass(e.options.btnExpand.iconAlt)
    ...
    Detector = {
        ...
        getWebGLErrorMessage: function () {
            ...
            if (!this.webgl) {
                e.innerHTML = window.WebGLRenderingContext ? ['Your graphics card does not seem to support <a href="https://khronos.org/webgl/wiki/Getting_a_WebGL_Implementation" style="color:#000">WebGL</a>.<br />', 'Find out how to get it <a href="https://get.webgl.org/" style="color:#000">here</a>.'].join("\n") : ['Your browser does not seem to support <a href="https://khronos.org/webgl/wiki/Getting_a_WebGL_Implementation" style="color:#000">WebGL</a>.<br/>', 'Find out how to get it <a href="https://get.webgl.org/" style="color:#000">here</a>.'].join("\n")
            }
            return e
        },
